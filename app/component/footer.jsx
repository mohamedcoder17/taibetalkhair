...
export default function Footer ({ page, settings }) {
    ...
    const subscribe = async (e) => {
        ...
        const response = await api('subscribe', {email: email});

        if ( response.status === true ) alert_msg($, "تهانينا - لقد تم إشتراكك بنجاح");
        else if ( response.status === 'exists' ) alert_msg($, "هذا الإيميل مشترك بالفعل");
    ...
    return (
        ...
        <Fragment>
            ...
            <div className="full-width flex flex-column scroll-bar no-select">
                
                <main className="flex flex-space">
             
                    <ul className="scroll-up flex" onClick={_ => $(window).scrollTop(0)}>
                        
                        <span>إذهب لأعلى</span>
                    ...
                    <ul className="pages flex">
                        ...
                        {
                            !page ?
                            <a className="no-hover">الصفحة الرئيسية</a> :
                            <div>
                    ...
                    <ul className="full-width flex flex-column">
                        ...
                        <li className="full-width flex flex-space">
                            ...
                            <div className="flex flex-start">
                                ...
                                <a href={settings.facebook} className="flex" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                                        <path fill="#039be5" d="M24 5A19 19 0 1 0 24 43A19 19 0 1 0 24 5Z"></path>
                                        <path fill="#fff" d="M26.572,29.036h4.917l0.772-4.995h-5.69v-2.73c0-2.075,0.678-3.915,2.619-3.915h3.119v-4.359c-0.548-0.074-1.707-0.236-3.897-0.236c-4.573,0-7.254,2.415-7.254,7.917v3.323h-4.701v4.995h4.701v13.729C22.089,42.905,23.032,43,24,43c0.875,0,1.729-0.08,2.572-0.194V29.036z"></path>
                                    </svg>
                                </a>
                                <a href={settings.youtube} className="flex" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                                ...
                                <a href={settings.whatsapp} className="flex" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                                ...
                                <a href={settings.instagram} className="flex" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                                ...
                                <a href={settings.telegram} className="flex" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                                ...
                                <a href={settings.twetter} className="flex" target="_blank">
                            ...
                            <Link href="/" className="flex logo">{settings.name}</Link>
                        ...
                        <li className="full-width flex flex-space align-start">
                            ...
                            <div className="flex flex-column align-start">
                                ...
                                <div><a className="head">أدخل الإيميل للإشتراك</a></div>

                                <form className="text full-width flex flex-column" onSubmit={subscribe}>

                                    <input type="email" placeholder="الإيميل" dir="rtl" className="full-width" required autoComplete="off"
                                        value={email} onChange={_ => setEmail(_.target.value.toLowerCase().trim())}/>

                                    <div className="full-width flex flex-end"><button>إشتراك</button></div>
                            ...
                            <div className="flex flex-column align-start">
                                ...
                                <div><a className="head">الوصول السريع</a></div>

                                <ul className="full-width flex flex-column">
                                    <div><Link href="/">الصفحة الرئيسية</Link></div>
                                    <div><Link href="/markets">المزادات</Link></div>
                                    <div><Link href="/about">من نحن</Link></div>
                            ...
                            <div className="flex flex-column align-start">
                                ...
                                <div><a className="head">تواصل معنا</a></div>

                                <ul className="full-width flex flex-column">
                                    <div><a href={`tel:${settings.phone}`}>{settings.phone}</a></div>
                                    <div><a>{settings.city}</a></div>
                            ...
                            <div className="flex flex-column align-start">
                                ...
                                <div><a className="head">من نحن</a></div>
            ...
            <div className="loader main-loader"></div>
